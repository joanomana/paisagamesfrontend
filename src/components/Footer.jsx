    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid gap-8 md:grid-cols-4">
            ...
            <form
                ...
                className="mt-4  flex rounded-xl border border-white/10 bg-white/5 p-1"
            >
                <input
                type="email"
                placeholder="tu@email.com"
                className="flex-1 bg-transparent px-3 py-2 text-sm text-white placeholder-white/50 outline-none"
                required
                />
                <button
                className="rounded-lg bg-gradient-to-r from-fuchsia-600 to-cyan-500 px-4 py-2  text-sm font-semibold text-white shadow-md shadow-fuchsia-500/20"
                >
                Suscribirme
                </button>
            </form>
